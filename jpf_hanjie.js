...
// Definiton of function that will change the puzzle based on which button was clicked
function swapPuzzle(e) {
   
   if(window.confirm("You will lose ALL of your work on the puzzle! \nContinue?")) {
...
function setupPuzzle() {
   ...
   document.getElementById("peek").addEventListener("click", function(){
       ...
       // Remove the hints after a cetain amount of time
       setTimeout(function() {
          for(let i = 0; i < puzzleCells.length; i++) {
...
// Definition of the extendBackground() function which keeps the backgroumd color going
